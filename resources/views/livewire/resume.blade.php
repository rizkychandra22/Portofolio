            ...
            <div class="row gy-4">
                <div class="col-lg-4">
                    <div class="resume-side" data-aos="fade-right" data-aos-delay="100">
                        <div class="profile-img d-flex justify-content-center mb-4">
                            <img src="{{ $imageResume?->foto_resume ? Storage::disk('cloudinary')->url($imageResume->foto_resume) : asset('template/assets/img/content/foto-resume.jpg') }}" crossorigin="anonymous" alt="Rizky Chandra" class="img-fluid rounded shadow-sm" fetchpriority="high">
                        </div>
                        {!! app()->getLocale() == 'id' ?
                            '   
                        ...
                        <ul class="contact-info list-unstyled">
                            ...
                            <li><i class="fab fa-linkedin"></i> {{ $sosialMedia->linkedin }}</li>
                            <li><i class="fab fa-github"></i> {{ $sosialMedia->github }}</li>
                        </ul>
