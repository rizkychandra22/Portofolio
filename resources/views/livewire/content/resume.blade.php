                ...
                <div class="col-lg-4">
                    <div class="resume-side" data-aos="fade-right" data-aos-delay="100">
                        <div class="profile-img mb-4">
                            <img src="{{ Storage::url($imageResume->foto_resume) ?? '/snapfolio/assets/img/content/foto-resume.jpg' }}" crossorigin="anonymous" alt="Rizky Chandra" class="img-fluid rounded shadow-sm" fetchpriority="high">
                        </div>
                        {!! app()->getLocale() == 'id' ?
                            '   
