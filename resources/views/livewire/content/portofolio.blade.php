                            ...
                            @forelse ($portofolio as $item)    
                                <div class="col-lg-6 col-md-6 portfolio-item isotope-item {{ $item->category->data_filter_category ?? '' }}">
                                    <div class="portfolio-wrap">
                                        <img src="{{ $item->image_project ?? '' }}" crossorigin="anonymous" fetchpriority="high" class="img-fluid" alt="{{ $item->{'name_project_' . app()->getLocale()} ?? '' }}">
                                        <div class="portfolio-info">
                                            <div class="content">
                                                ...
                                                <div class="portfolio-links">
                                                    <a href="{{ $item->image_project ?? '' }}" crossorigin="anonymous" class="glightbox" 
